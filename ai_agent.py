...
if user_input:
    # Check if input contains both weather and news requests
    user_lower = user_input.lower()
    asks_weather = "weather" in user_lower
    asks_news = "news" in user_lower

    if asks_weather and asks_news:
        warning_msg = (
            "❌ Please ask one thing at a time. "
            "For example, first ask about the weather 🌤️, then ask for news 📰 or vice versa."
        )
